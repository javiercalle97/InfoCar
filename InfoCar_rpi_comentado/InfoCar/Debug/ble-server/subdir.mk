...
C_SRCS += \
../ble-server/advertising.c \
../ble-server/gatt-service.c 

OBJS += \
./ble-server/advertising.o \
./ble-server/gatt-service.o 

C_DEPS += \
./ble-server/advertising.d \
./ble-server/gatt-service.d 


# Each subdirectory must supply rules for building sources it contributes
ble-server/%.o: ../ble-server/%.c
	@echo 'Building file: $<'
